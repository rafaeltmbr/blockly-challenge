# Blockly Challenge
This is series of programming challenges with Blockly. It gradually increases its difficult and requires more programming concepts from the user.
...
A live demo can be found at https://rafaeltmbr.github.io/blockly-challenge